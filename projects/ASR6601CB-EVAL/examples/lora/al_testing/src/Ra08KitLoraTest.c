...
//char sendBuf[] = "helloABBBBBBBBBBBBBBJJJJJJJJJJJJJDDDDDDDDDIIIIIIIIIII"; //发送的数据
...
//将数据发送到网关。
uint8_t send_to_gateway()
{
    uint8_t sta=0;
	//准备发送数据：网关参数（地址、频率）本机参数（地址、频率）温湿度 时间戳、电量、信号强度,组成数据包
	

	//1.按网关参数设置本机发送参数，并将数据包存储在本地。
	//循环10次
