 ...
 */
#define TREMO_ANALOG_RD(addr)        (*(volatile uint32_t*)((AFEC_BASE) | ((addr) << 2)))//*(uint32_t*)(AFEC_BASE|(addr << 2))
 
/**
 * @brief Write the value into the analog register
 */
#define TREMO_ANALOG_WR(addr, value) (*(volatile uint32_t*)((AFEC_BASE) | ((addr) << 2))) = (value)//*(uint32_t*)(AFEC_BASE | (addr << 2)) = value
...
#define I2C_CR_TWSI_UNIT_EN_MASK      ((uint32_t)0x00004000)//从机地址检测标志
#define I2C_CR_SCL_EN_MASK            ((uint32_t)0x00002000)//22 总线错误标志
#define I2C_CR_MASTER_ABORT_MASK      ((uint32_t)0x00001000)//NC
#define I2C_CR_BUS_RESET_REQUEST_MASK ((uint32_t)0x00000800)//DBR接收满标志
#define I2C_CR_UNIT_RESET_MASK        ((uint32_t)0x00000400)//DBR发送空
